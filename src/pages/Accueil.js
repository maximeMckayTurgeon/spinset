		...
		<Container>
			<div className="accueil">
				<h1 className="text-center mb-5 mt-3 ">
					<CountUp end={nbrAlbums} duration={1.5} /> Albums en stock! On écoute
					quoi?
				</h1>
				<Row className="justify-content-center menuAccueil shadow  rounded">
					<Col className="text-center my-2">
						<button className="fancy" value="random" onClick={chooseModule}>
					...
					<Col className="text-center my-2">
						<button className="fancy" value="filter" onClick={chooseModule}>
							<span className="top-key"></span>
					...
					<Col className="text-center my-2">
						<button className="fancy" value="search" onClick={chooseModule}>
							<span className="top-key"></span>
					...
					<Col className="text-center my-2">
						<button className="fancy" value="playlist" onClick={chooseModule}>
							<span className="top-key"></span>
